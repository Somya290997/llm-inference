...
from page_table.page_table_batches_2 import PageTable
...
from decode_worker.decode_worker_batches_2 import decode_one_token_step
...
class Runtime:
    ...
    def __init__(self):
        ...
        # self.decode_model.config.attn_implementation = "eager"
        # try:
        #     self.decode_model._hf_hook = None
        #     self.decode_model.forward = self.decode_model._old_forward
        #     print("[Compile Info] Accelerate hooks removed.")
        # except:
        #     print("[Compile Info] No accelerate hooks found.")
