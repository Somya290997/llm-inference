...
KV blocks are managed through CPU side paging structures when full GPU
level implementation was constrained by architecture or framework
limitations.

This improves memory footprint control and enables experimentation with
space optimized KV management.
...
These results demonstrate the effectiveness of separating compute phases
and coordinating memory movement.
